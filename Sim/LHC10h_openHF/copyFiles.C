...
void copyFiles(TString gridLocation)
{
  ...
  gSystem->Exec(Form("alien_cp file:%s/JPsi/Config.C alien://%s/Config.C", localDir.Data(), targetDir.Data()));
  gSystem->Exec(Form("alien_cp file:%s/JPsi/run.jdl alien://%s/run.jdl", localDir.Data(), targetDir.Data()));
  gSystem->Exec(Form("alien_cp file:%s/JPsi/simrun.C alien://%s/simrun.C", localDir.Data(), targetDir.Data()));
