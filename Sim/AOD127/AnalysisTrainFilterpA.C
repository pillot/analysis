...
TString     train_tag          = "_p-A_";        // Train special tag appended to 
...
TString     job_comment        = "Standard AODs + muon deltas";
...
TString     aliroot_version    = "v5-03-Rev-18";  // *CHANGE ME IF MORE RECENT IN GRID*                                          
// Change production base directory here (test mode)
TString     alien_datadir      = "/alice/data/2013/LHC13f";
...
TString     data_pattern       = "*ESDs/muon_calo/*ESDs.root";
// Set the run range
Int_t run_numbers[10] = {197388}; // **********************!!!!!!!
