...
TString     aliroot_version    = "v5-04-05-AN";  // *CHANGE ME IF MORE RECENT IN GRID*                                          
// Change production base directory here (test mode)
TString     alien_datadir      = "/alice/cern.ch/user/p/ppillot/Sim/LHC11h/JPsiPb276pm2/MUL/test2/results";
Int_t       run_flag           = 1100;   // year (2011 = 1100)

// Work directory in GRID (DON'T CHANGE)
TString     grid_workdir       = "Sim/LHC11h/JPsiPb276pm2/MUL/test2";
