...
void copyFiles(TString gridLocation)
{
  ...
  gSystem->Exec(Form("alien_cp file:%s/LowMasses/Config.C alien://%s/Config.C", localDir.Data(), targetDir.Data()));
  gSystem->Exec(Form("alien_cp file:%s/LowMasses/run.jdl alien://%s/run.jdl", localDir.Data(), targetDir.Data()));
  gSystem->Exec(Form("alien_cp file:%s/LowMasses/simrun.C alien://%s/simrun.C", localDir.Data(), targetDir.Data()));
