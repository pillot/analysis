...
// beam energy
static Int_t energy = 2760; // energy in CMS
...
void Config()
{
  ...
  if (energy == 2760) gener->SetCMSEnergy(AliGenMUONLMR::kCMS2760GeV);
  else gener->SetCMSEnergy(AliGenMUONLMR::kCMS7000GeV);
  gener->SetMomentumRange(0,999);
  gener->SetPhiRange(0.,360);
  gener->SetYRange(-4.5,-2.);
  gener->SetPtRange(0.,100);
  gener->SetCutOnChild(1);
  gener->SetChildThetaRange(0.,180); 
  gener->SetChildPtRange(0.,100); 
  //gener->SetScaleMultiplicity(AliGenMUONLMR::kPionLMR,1); 
  //gener->SetScaleMultiplicity(AliGenMUONLMR::kKaonLMR,1); 
  ...
  Float_t gamma   = ((Float_t)energy) / 2.0 / 0.938272;  // relativistic gamma [1]
