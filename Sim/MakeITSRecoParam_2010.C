void MakeITSRecoParam_2010(AliRecoParam::EventSpecie_t default=AliRecoParam::kHighMult,
			   const char* cdbURI="alien://folder=/alice/cern.ch/user/p/ppillot/OCDB_PbPbSim") {
//========================================================================
//
...
//========================================================================
...

  {
    ...
    itsRecoParam->SetVertexerSmearMC(0.00001,0.00001,0.00001);
