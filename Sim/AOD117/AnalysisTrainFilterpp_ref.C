...
TString     aliroot_version    = "v5-04-04-AN";  // *CHANGE ME IF MORE RECENT IN GRID*                                          
// Change production base directory here (test mode)
TString     alien_datadir      = "/alice/data/2011/LHC11e";
Int_t       run_flag           = 1000;   // year (2011 = 1100)
...
TString     data_pattern       = "*ESDs/limited_trigger_set/*ESDs.root";
// Set the run range
