...
//  TString extAfter = "_after";
  ...
  TString sHist[nHists] = {"hChi2", "hNClustersPerTrack", "hNChamberHitPerTrack", "hNTracks", "hDCA", "hPt", "hRapidity", "hNTrigAll", /*"hPDCA23","hPDCA310",*/"hMass", /*"hPUncorrected"*/"hPtDimu", "hRAbs", "hNMatchTracks", "hPtMuPlus", "hPtMuMinus", "hChi2Trig", "hMultSelect"};
