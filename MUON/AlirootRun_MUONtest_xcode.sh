#!/bin/sh
# $Id: AlirootRun_MUONtest.sh 24932 2008-04-04 14:58:26Z laphecet $

export ALICE="/Users/philippe/Work/Alice/Work"
export ALICE_LEVEL="head"
...
export G3SYS="${GEANT3}"
export GEANT_TARGET="${ALICE_TARGET}"
if [ ! -n "$DYLD_LIBRARY_PATH" ]; then
  export DYLD_LIBRARY_PATH="${GEANT3}/lib/tgt_${GEANT_TARGET}:${ALICE_ROOT}/lib/tgt_${ALICE_TARGET}:${ROOTSYS}/lib:${DYLD_LIBRARY_PATH}"
else
  export DYLD_LIBRARY_PATH="${GEANT3}/lib/tgt_${GEANT_TARGET}:${ALICE_ROOT}/lib/tgt_${ALICE_TARGET}:${ROOTSYS}/lib"
fi
export PATH="${ROOTSYS}/bin:${ALICE_ROOT}/bin/tgt_${ALICE_TARGET}:${PATH}"

export ROOTBUILD="g95"
