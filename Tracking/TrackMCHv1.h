...
#ifndef ALICEO2_MCH_TRACKMCHV1_H_
#define ALICEO2_MCH_TRACKMCHV1_H_
...
class TrackMCHv1
{
 ...
 public:
  TrackMCHv1() = default;
  TrackMCHv1(double z, const TMatrixD& param, const TMatrixD& cov, double chi2, int firstClIdx, int nClusters)
  ...
  TrackMCHv1(const TrackMCHv1& track) = default;
  TrackMCHv1& operator=(const TrackMCHv1& track) = default;
  TrackMCHv1(TrackMCHv1&&) = default;
  TrackMCHv1& operator=(TrackMCHv1&&) = default;
 ...
 private:
  ...
  ClassDefNV(TrackMCHv1, 1);
};

} // namespace mch
} // namespace o2

#endif // ALICEO2_MCH_TRACKMCHV1_H_
