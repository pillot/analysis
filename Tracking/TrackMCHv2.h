...
#ifndef ALICEO2_MCH_TRACKMCHV2_H_
#define ALICEO2_MCH_TRACKMCHV2_H_
...
class TrackMCHv2
{
 ...
 public:
  TrackMCHv2() = default;
  TrackMCHv2(double z, const TMatrixD& param, const TMatrixD& cov, double chi2, int firstClIdx, int nClusters,
  ...
  TrackMCHv2(const TrackMCHv2& track) = default;
  TrackMCHv2& operator=(const TrackMCHv2& track) = default;
  TrackMCHv2(TrackMCHv2&&) = default;
  TrackMCHv2& operator=(TrackMCHv2&&) = default;
  ...
  double getPx() const { return getPz() * mParam[1]; }
  /// return track momentum along y
  double getPy() const { return getPz() * mParam[3]; }
 ...
 private:
  ...
  ClassDefNV(TrackMCHv2, 2);
};

} // namespace mch
} // namespace o2

#endif // ALICEO2_MCH_TRACKMCHV2_H_
