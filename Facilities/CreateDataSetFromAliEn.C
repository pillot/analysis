...
//  TString connStr   = "ppillot@nansafmaster.in2p3.fr",
  TString connStr   = "ppillot@alice-caf.cern.ch",
//  TString connStr   = "ppillot@kiaf.sdfarm.kr",
//  TString connStr   = "ppillot@skaf.saske.sk",
  ...
  TString basePath  = "/alice/data/2011/LHC11e/<RUN9>/ESDs/cpass1/*.*",
//  TString basePath  = "/alice/cern.ch/user/p/ppillot/Data/LHC11a/BOFF/AlignSurvey/<RUN9>/*.*",
  TString fileName  = "AliESDs.root",
  TString filter    = "",
  TString anchor    = "",
  TString treeName  = "/esdTree",
  TString runList   = "162627",
  TString dsPattern = "/MUON/ppillot/data_LHC11e_000162627_ESDs_p1",
