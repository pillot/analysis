...
{
  /// Compute efficiencies at DE, chamber, station and spectrometer level versus various variables from the output of the efficiency task
...
void PlotIntegratedMuonEfficiencyVsX(TString var, TString runList, TString fileNameWeights,
                                     TString fileNameData, TString fileNameSave, Bool_t print, Bool_t draw)
{
  /// plot the tracking efficiency vs versus for each run and integrated
...
//---------------------------------------------------------------------------
void SetCentPtCh(THnSparse& SparseData) //Added by Javier Martin
{
...
//---------------------------------------------------------------------------
TGraphAsymmErrors* CreateGraph(const char* name, const char* title, int value) //Added by Javier Martin
{
