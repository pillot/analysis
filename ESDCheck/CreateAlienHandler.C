...
//  plugin->SetAliROOTVersion("v4-18-Rev-10");
...
//  plugin->SetGridDataDir("/alice/cern.ch/user/p/ppillot/pp7TeV/LHC10c/pass2");
...
//  plugin->SetDataPattern("*ESD.tag.root");
  ...
  plugin->SetGridWorkingDir("pp7TeV/LHC10c/Pos/ESDCheck2");
//  plugin->SetGridWorkingDir("pp7TeV/LHC10c/pass2/ESDCheck");
//  plugin->SetGridWorkingDir("pp7TeV/LHC10c/pass2_GMS/ESDCheck");
//  plugin->SetGridWorkingDir("pp7TeV/LHC10c/pass1/ESDCheck");
  ...
  plugin->SetAnalysisSource("AliCounterCollection.cxx AliAnalysisTaskESDCheck.cxx");
  
  // Declare all libraries (other than the default ones for the framework. These will be
  // loaded by the generated analysis macro. Add all extra files (task .cxx/.h) here.
  plugin->SetAdditionalLibs("libRAWDatabase.so libCDB.so libSTEER.so libMUONcore.so libMUONmapping.so libMUONcalib.so libMUONgeometry.so libMUONtrigger.so libMUONraw.so libMUONbase.so libMUONrec.so AliAnalysisTaskESDCheck.h AliAnalysisTaskESDCheck.cxx AliCounterCollection.h AliCounterCollection.cxx");
  ...
  plugin->SetAnalysisMacro("ESDCheckAnalysis.C");
  plugin->SetExecutable("ESDCheckAnalysis.sh");
  ...
  plugin->SetJDLName("ESDCheckAnalysis.jdl");
